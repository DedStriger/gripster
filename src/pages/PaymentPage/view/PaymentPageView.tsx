      ...
      >
        <div className={styles.row}>
          <input
            type="text"
            name="email"
            className={error?.place === "email" ? styles.error : ""}
            placeholder="Email"
            required
          />
          <input
            type="tel"
            name="phone"
            className={error?.place === "phone" ? styles.error : ""}
        ...
        <div className={styles.row}>
          <input
            type="text"
            name="secondName"
            className={error?.place === "secondName" ? styles.error : ""}
            placeholder="Фамилия"
            required
          />
          <input
            type="text"
            name="firstName"
            className={error?.place === "firstName" ? styles.error : ""}
            placeholder="Имя"
            required
          />
          <input
            type="text"
            name="fatherName"
            className={error?.place === "fatherName" ? styles.error : ""}
        ...
        <div className={styles.row}>
          <input
            type="text"
            name="city"
            className={error?.place === "city" ? styles.error : ""}
            placeholder="Город"
            required
          />
          <input
            type="text"
            name="street"
            className={error?.place === "street" ? styles.error : ""}
            placeholder="Улица"
            required
          />
        </div>
        <div className={styles.row}>
          <input
            type="text"
            name="house"
            className={error?.place === "house" ? styles.error : ""}
            placeholder="Дом"
          />
          <input
            type="text"
            name="apartment"
            className={error?.place === "apartment" ? styles.error : ""}
